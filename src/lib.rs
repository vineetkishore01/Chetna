...
pub struct AppState {
    ...
    pub session_cache: Arc<cache::SessionCache>,
}
...
impl AppState {
    pub fn new(config: Config) -> Result<Self> {
        ...
        let session_cache = Arc::new(cache::SessionCache::new(config.session_cache_size));
...
pub fn create_router(state: AppState) -> Router {
    ...
    api::create_router(brain.clone(), session_cache.clone(), user_config.clone())
        .merge(web::routes())
